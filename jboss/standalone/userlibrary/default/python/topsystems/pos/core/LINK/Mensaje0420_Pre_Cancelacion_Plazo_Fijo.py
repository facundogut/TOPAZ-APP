...
class Mensaje0420_Pre_Cancelacion_Plazo_Fijo(MessageDefinition):
    ...
    def originalRequestEffectivelyProcessed(self, responseToOriginalMessage) :
            return responseToOriginalMessage != None and (responseToOriginalMessage.getResponseCode() == "00" or responseToOriginalMessage.getResponseCode() == "99")
