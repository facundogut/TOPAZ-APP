...
class Mensaje0200_Transferencias_CBU(MessageDefinition):
    ...
    def createRequest(self):
        ...
        operRequest.setOperationNumber(7611)
        ...
        cbu = self.posMessage.getElement54().strip()
        ...
        operRequest.addParameter("CBU", cbu)
