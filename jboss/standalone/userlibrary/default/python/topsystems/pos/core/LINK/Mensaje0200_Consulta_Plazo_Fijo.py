...
class Mensaje0200_Consulta_Plazo_Fijo(MessageDefinition):
    ...
    def createRequest(self):
        ...
        # numero de operacion
        operRequest.setOperationNumber(7606)
        ...
        operRequest.addParameter("CERTIFICADO", certificadoDpf)
        operRequest.addParameter("FECHA_VENC", fechaDpf)
        operRequest.addParameter("IMPORTE_PLAZO", importeDpf)
    ...
    def basicCreateResponse(self):
        ...
        self.posMessage.removeBodyElement(95) 
        self.posMessage.removeBodyElement(98) 
        self.posMessage.removeBodyElement(122) 
        self.posMessage.removeBodyElement(123)
        self.posMessage.removeBodyElement(48)        
