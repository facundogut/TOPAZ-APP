...
class Mensaje0420_Retiros(MessageDefinition):
    def __init__(self, isoMessage, context):
        ...
        self.responseToOriginalMessage=""
    ...
    def createRequest(self):
        if (self.posMessage.getResponseCode() == "68" and (self.posMessage.getCardAcceptorNameAndPlace() == "** REVERSAL FOR LATE/UNSOL RESPONSE **  " or self.posMessage.getCardAcceptorNameAndPlace() == "** REVERSAL FOR LATE/UNSOL RESPONSE **AR")):
        ...
        #Log.debug(self.responseToOriginalMessage.toString())
    ...
    def createResponse(self, extornResponse):
        ...
        Log.debug(self.posMessage.getResponseCode())
        ...
        #Correccion para que en la respuesta sea 0430, por mas que no tenga error de timeout (68) 
