	...
	BEGIN
     ...
     INSERT INTO CON_CERTIFICADOS_RETENCION
      	SELECT
		    ...
		    CASE WHEN D.MOV_MONEDA <>1 AND MON.C6403 <> ''I'' THEN
		    ...
		    WHEN D.MOV_MONEDA <>1 AND MON.C6403 = ''I'' THEN
		    (	SELECT SUM(CAPITALREALIZADO)
		    	FROM MOVIMIENTOS_CONTABLES WITH(nolock)
		    	WHERE
		    		ASIENTO = D.MOV_ASIENTO
		    ...
		    CASE WHEN D.MOV_MONEDA <>1 AND MON.C6403 <> ''I'' THEN FL.MONTO_IMPONIBLE *CB.TC_VENTA 
		         WHEN D.MOV_MONEDA <>1 AND MON.C6403  = ''I'' THEN FL.MONTO_IMPONIBLE *HTC.TIPO_CAMBIO_VENTA
		    ELSE FL.MONTO_IMPONIBLE END AS MONTO_IMPONIBLE,
		    
		    
		    CASE WHEN D.MOV_MONEDA <>1 AND MON.C6403 <> ''I'' THEN FL.IMPORTEMN*CB.TC_VENTA 
		         WHEN D.MOV_MONEDA <>1 AND MON.C6403  = ''I'' THEN FL.IMPORTEMN*HTC.TIPO_CAMBIO_VENTA
