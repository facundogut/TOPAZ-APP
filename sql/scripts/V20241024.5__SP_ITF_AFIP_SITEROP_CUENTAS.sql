...
BEGIN
   ...
   INSERT INTO ITF_AFIP_SITEROP_HIST(	TIPO_REGISTRO, CUIT_INFORMANTE 	, PERIODO_INFORMADO	, SECUENCIA 	, CODIGO_ENTIDAD_FINANCIERA   	, CODIGO_IMPUESTO 	, CODIGO_CONCEPTO , NUMERO_FORMULARIO 	, VERSION 	, PRESENTACION_SIN_MOVIMIENTO, FECHA_PROCESO )
	...
	SELECT       
           ...
           '01'  AS Caracter,           
           '01' AS Cantidad_Tarjetas_Debito_Adicionales,
           '000000000000000000' AS Total_extracciones_pais_exterior,
           '1' AS Signo_Saldo,
           '000000000000000000' AS Saldo,
           '1'   AS Signo_Consumo_Tarjetas_debito_pais,
           '000000000000000000'   AS Consumos_Tarjetas_debito_pais,
           '1'   AS Signo_Consumo_Tarjetas_debito_exterior,
           '000000000000000000' AS Consumos_Tarjetas_debito_exterior,
            cli.CODIGOCLIENTE,
            s.JTS_OID,
	...
	BEGIN
	    ...
	    SET @R02_TOTAL_ACREDITACIONES = FORMAT((@R02_SUMA_ACRED_PESOS + @R02_SUMA_ACRED_EXTR),'000000000000000000');
	    
	    PRINT @R02_SUMA_ACRED_PESOS 
	    PRINT @R02_SUMA_ACRED_EXTR 
	    PRINT @R02_SUMA_ACRED_PESOS + @R02_SUMA_ACRED_EXTR	    
