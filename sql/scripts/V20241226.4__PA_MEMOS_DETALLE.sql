   ...
   BEGIN
      ...
      SET @COTIZACION = (SELECT TOP 1 TIPO_CAMBIO_OFICIAL FROM HISTORICOTIPOSCAMBIO WITH(NOLOCK) WHERE MONEDA=2 AND FECHA_COTIZACION <= @FECHA_PROCESO ORDER BY FECHA_COTIZACION DESC)
			   ...
			   SELECT DISTINCT
                 ...
                 WHERE FECHA_PROCESO = @FECHA_PROCESO and TIPO_ASISTENCIA in (''P'', ''D'')
			...
			UNION ALL 
				...
				SELECT DISTINCT
                 ...
                 CASE WHEN VA.SALDO_ACUERDO <> 0 AND ISNULL(VA.IMPORTE_CONSUMIDO,0) = 0 THEN 0 ELSE ABS(S.C1604) END, --- AS Capital adeudado
                 0 AS DIAS_ATRASO,
                 S.C1621,
                 NULL AS PRIMER_VENC,
                 NULL AS VENCIMIENTO,
               ...
               --CC monto sobregiro > acuerdo
				SELECT DISTINCT
                 ...
                 0 AS NUM_TJC,
                 NULL AS ADMINISTRADORA,
                 (S.C1604 - S.C1683), --- AS Capital adeudado
                 0 AS DIAS_ATRASO,
                 S.C1621,
                 NULL AS PRIMER_VENC,
                 NULL AS VENCIMIENTO,
                 ...
                 (S.C1785 = 2 AND S.C1651<>''1'')
                 AND S.C1621 <= @FECHA_PROCESO
                 AND S.C1604 > S.C1683 AND S.C1683 <> 0
