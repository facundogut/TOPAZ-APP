...
--------------------------------Cheques Propios
	...
	if exists (	select a.NROCHEQUE 
				...
				where b.NUMERO_CHEQUE is null
					and b.NUMERO_SERIE is null
					and b.SUCURSAL is null
					and b.CUENTA is null
					and b.BANCO_DEPOSITANTE is null
					and b.FECHA_EMISION is null
			)	
...
if exists (		select a.CODIGO_RECHAZO  
	...
	if exists (	select a.NUMERO_CHEQUE 
				...
				where b.SUCURSAL is null
					...
					and b.COD_BANCO is null
					and b.NUMERO_DEL_CHEQUE is null
					and b.TIPO_DOCUMENTO is null
					and b.NUMERO_CUENTA_GIRADORA is null
