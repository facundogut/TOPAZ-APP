...
EXECUTE('
--A TODOS FECHA PROX PROCESO = 20241026
UPDATE dbo.PM_SCHEDULER
SET FECHAPROXEJECUCION = ''20241026''
...
EXECUTE('
--''TJC - Cobro tarjeta de credito - Se saca del cierre y corre en el batch de Adintar
UPDATE dbo.PM_SCHEDULER
SET FECHAPROXEJECUCION = ''20990101''
WHERE ORDINAL = 46 AND NOMBREGRUPO = ''     DIA - Procesos de Cierre Integrada ''
')
...
UPDATE dbo.PM_SCHEDULER
SET FECHAPROXEJECUCION = ''20990101''
WHERE ORDINAL = 49 AND NOMBREGRUPO = ''     DIA - Procesos de Cierre Integrada ''
')
...
WHERE ORDINAL = 75 AND NOMBREGRUPO = ''     DIA - Procesos de Cierre Integrada ''
')
...
UPDATE dbo.PM_SCHEDULER
SET FECHAPROXEJECUCION = ''20990101''
WHERE ORDINAL = 113 AND NOMBREGRUPO = ''     DIA - Procesos de Cierre Integrada ''
')