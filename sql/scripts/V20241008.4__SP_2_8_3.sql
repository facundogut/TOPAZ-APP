...
(' 
	...
	drop table if exists dbo.TTR_CODIGO_TRANSACCION_INFO_EXTENDIDA; 
	drop table if exists dbo.TTR_CODIGO_PROGRAMA_TRANSACCION;
');
...
('
	...
	(
		...
		infoExtendidaTipo numeric(2,0) not null default 0, 
	...
	create table dbo.TTR_CODIGO_TRANSACCION_INFO_EXTENDIDA
	(
		codigoTransaccion numeric(5,0) not null, 
		infoExtendidaTipo numeric(2,0) not null default 0, 
		descripcion varchar(150) COLLATE Modern_Spanish_CI_AS not null default '' '', 
		TZ_LOCK numeric(15,0) DEFAULT 0 NOT NULL, 
		CONSTRAINT TTR_CODIGO_TRANSACCION_INFO_EXTENDIDA_PK PRIMARY KEY (codigoTransaccion) 
	); 

	CREATE TABLE dbo.TTR_CODIGO_PROGRAMA_TRANSACCION 
	(
	codigoPrograma numeric(5,0) PRIMARY KEY DEFAULT 0 NOT NULL,
	nombrePrograma varchar(60) COLLATE Modern_Spanish_CI_AS DEFAULT '' '' NULL,
	descripcion varchar(150) COLLATE Modern_Spanish_CI_AS DEFAULT '' '' NULL,
	TZ_LOCK numeric(15,0) DEFAULT 0 NOT NULL
	);
');
...
EXECUTE 
('
	DELETE FROM dbo.DESCRIPTORES WHERE IDENTIFICACION in (30,35);
	DELETE FROM dbo.DICCIONARIO WHERE NUMERODECAMPO in (7913,7914,7915,8122,8135,8136,8137,7835);
	DELETE FROM dbo.AYUDAS WHERE NUMERODEAYUDA in (2,8758);
	DELETE FROM dbo.OPERACIONES WHERE IDENTIFICACION in (126,99);
	DELETE FROM dbo.INDICES WHERE NUMERODEARCHIVO in (30,35);
');
...
('
	INSERT INTO DESCRIPTORES (TITULO,IDENTIFICACION,TIPODEARCHIVO,DESCRIPCION,GRUPODELMAPA,NOMBREFISICO,TIPODEDBMS,LARGODELREGISTRO,INICIALIZACIONDELREGISTRO,BASE,SELECCION,ACEPTA_MOVS_DIFERIDO) VALUES
		 (10,30,NULL,''TTR_CODIGO_TRANSACCION_INFO_EX'',0,''TTR_CODIGO_TRANSACCION_INFO_EXTENDIDA'',''D'',NULL,NULL,''Top/Clientes'',NULL,''N''),
		 (10, 35,NULL,''TTR_CODIGO_PROGRAMA_TRANSACCIO'', 0,''TTR_CODIGO_PROGRAMA_TRANSACCION'',''D'', NULL, NULL,''Top/Clientes'', NULL,''N'');
	...
	INSERT INTO DICCIONARIO (NUMERODECAMPO,USODELCAMPO,REFERENCIA,DESCRIPCION,PROMPT,LARGO,TIPODECAMPO,DECIMALES,EDICION,CONTABILIZA,CONCEPTO,CALCULO,VALIDACION,TABLADEVALIDACION,TABLADEAYUDA,OPCIONES,TABLA,CAMPO,BASICO,MASCARA) VALUES
		 (7913,'' '',0,''codigoTransaccion'',''codigoTransaccion'',5,''N'',0,NULL,0,0,0,0,0,0,0,30,''codigoTransaccion'',0,NULL),
		 (7914,'' '',0,''infoExtendidaTipo'',''infoExtendidaTipo'',2,''N'',0,NULL,0,0,0,0,0,0,0,30,''infoExtendidaTipo'',0,NULL),
		 (7915,'' '',0,''descripcion'',''descripcion'',150,''A'',0,NULL,0,0,0,0,0,0,0,30,''descripcion'',0,NULL),
		 (8122,'' '',0,''AyudaCodTransExt'',''AyudaCodTransExt'',5,''N'',0,NULL,0,0,0,0,0,8758,0,0,''C8122'',0,NULL),
		 (8135,'' '', 0,''codigoPrograma'',''codigoPrograma'', 5,''N'', 0, NULL, 0, 0, 0, 0, 0, 0, 0, 35,''codigoPrograma'', 0, NULL),
		 (8136,'' '', 0,''descripcion'',''descripcion'', 150,''A'', 0, NULL, 0, 0, 0, 0, 0, 0, 0, 35,''descripcion'', 0, NULL),
		 (8137,'' '', 0,''AyudaCodProgTransCL'',''AyudaCodProgTransCL'', 5,''N'', 0, NULL, 0, 0, 0, 0, 0, 2, 0, 0,''C8137'', 0, NULL),
		 (7835,'' '', 0,''nombrePrograma'',''nombrePrograma'', 100,''A'', 0, NULL, 0, 0, 0, 0, 0, 0, 0, 35,''nombrePrograma'', 0, NULL);
	...
	INSERT INTO INDICES (NUMERODEARCHIVO,NUMERODEINDICE,DESCRIPCION,CLAVESREPETIDAS,CAMPO1,CAMPO2,CAMPO3,CAMPO4,CAMPO5,CAMPO6,CAMPO7,CAMPO8,CAMPO9,CAMPO10,CAMPO11,CAMPO12,CAMPO13,CAMPO14,CAMPO15,CAMPO16,CAMPO17,CAMPO18,CAMPO19,CAMPO20) VALUES
		 (30,1,''codTransaccion'',0,7913,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
		 (35,1,''codigoPrograma'',0,8135,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
	...
	INSERT INTO AYUDAS (NUMERODEARCHIVO,NUMERODEAYUDA,DESCRIPCION,FILTRO,MOSTRARTODOS,CAMPOS,CAMPOSVISTA,BASEVISTA,NOMBREVISTA,AYUDAGRANDE) VALUES
		 (30,8758,''AyudaCodTransExt'','''',0,''7913R;7914;7915;'',NULL,NULL,NULL,0),
		 (35, 2,''AyudaCodProgTrans'','''', 0,''8135R;7835;8136;'', NULL, NULL, NULL, 0);
	...
	INSERT INTO OPERACIONES (TITULO,IDENTIFICACION,NOMBRE,DESCRIPCION,MNEMOTECNICO,AUTORIZACION,FORMULARIOPRINCIPAL,PROXOPERACION,ESTADO,TZ_LOCK,COPIAS,SUBOPERACION,PERMITEBAJA,COMPORTAMIENTOENCIERRE,REQUIERECONTRASENA,PERMITECONCURRENTE,PERMITEESTADODIFERIDO,ICONO_TITULO,ESTILO) VALUES
		 (6800,99,''ABMC - TTR CODIGO TRANSACCION INFO EXTENDIDA'',''TTR CODIGO TRANSACCION INFO EXTENDIDA'',''99'',''N'',NULL,NULL,''P'',0,NULL,0,''S'',''N'',''N'',''N'',''N'',NULL,0),
		 (6800, 126,''ABMC - TTR CODIGO PROGRAMA TRANSACCION'',''TTR CODIGO PROGRAMA TRANSACCION'',''126'',''N'', NULL, NULL,''P'', 0, NULL, 0,''S'',''N'',''N'',''N'',''N'', NULL, 0);
	
	INSERT INTO dbo.TTR_CODIGO_PROGRAMA_TRANSACCION (codigoPrograma, nombrePrograma, descripcion, TZ_LOCK) VALUES
		 (1,''MP_INFO_EXTENDIDA_TRANSFERENCIAS'',''Programa Crédito Transferencia'', 0),
		 (2,''MP_INFO_EXTENDIDA_PLAZO_FIJO'',''Programa Plazo Fijo'', 0),
		 (3,''MP_INFO_EXTENDIDA_PRESTAMOS'',''Programa Préstamo'', 0);

	INSERT INTO TTR_CODIGO_TRANSACCION_INFO_EXTENDIDA (codigoTransaccion,infoExtendidaTipo,descripcion,TZ_LOCK) VALUES
		 (21,1,''Credito transferencia'',0),
		 (22,1,''Credito transferencia'',0),
		 (23,1,''Credito transferencia'',0),
		 (24,1,''Credito transferencia'',0),
		 (25,1,''Credito transferencia'',0),
		 (26,1,''Credito transferencia'',0),
		 (27,1,''Credito transferencia'',0),
		 (28,1,''Debito transferencia'',0),
		 (29,1,''Debito transferencia'',0),
		 (30,1,''Debito transferencia'',0),
		 (31,1,''Debito transferencia'',0),
		 (32,1,''Debito transferencia'',0),
		 (33,1,''Debito transferencia'',0),
		 (34,1,''Debito transferencia'',0),
		 (48,2,''Plazo fijo'',0),
		 (49,2,''Plazo fijo'',0),
		 (50,2,''Plazo fijo'',0),
		 (3017,3,''Préstamos'',0);
