...
--	INNER JOIN VTA_SALDOS v ON ((t.BEN_CBU=v.CTA_CBU and t.OP_CLASE_TRANS='R' AND t.ESTADO='RC') OR (t.ORD_CBU=v.CTA_CBU AND t.OP_CLASE_TRANS='E' AND t.ESTADO='PP')) AND t.OP_MONEDA=1   
