...
EXECUTE('
--A TODOS FECHA PROX PROCESO = 20250401
UPDATE dbo.PM_SCHEDULER
SET FECHAPROXEJECUCION = ''20250401''
...
UPDATE dbo.PM_SCHEDULER
SET FECHAPROXEJECUCION = ''20250403''
...
UPDATE dbo.PM_SCHEDULER
SET FECHAPROXEJECUCION = ''20990101''
WHERE ORDINAL = 69 AND NOMBREGRUPO = ''     DIA - Procesos de Cierre Integrada ''

--''CRE - Sistema Interno de Calificacion'' - NO CORRE
UPDATE dbo.PM_SCHEDULER
SET FECHAPROXEJECUCION = ''20990101''
WHERE ORDINAL = 109 AND NOMBREGRUPO = ''     DIA - Procesos de Cierre Integrada ''
')