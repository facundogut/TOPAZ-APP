...
--15
CAST(YEAR(FECHA_PAGO_CHEQUE) AS CHAR(4)) AS [FechaPagoCheque_Anio],
RIGHT(''0''+ CAST(MONTH(FECHA_PAGO_CHEQUE) AS VARCHAR), 2) AS [FechaPagoCheque_Mes],
RIGHT(''0'' + CAST(DAY(FECHA_PAGO_CHEQUE) AS VARCHAR), 2) AS [FechaPagoCheque_Dia],
--16
