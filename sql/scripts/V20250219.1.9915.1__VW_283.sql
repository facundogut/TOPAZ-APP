EXECUTE('
	DROP INDEX IF EXISTS IDX_NBCH24_REL_TJD_CTA_01 ON TJD_REL_TARJETA_CUENTA;
	DROP INDEX IF EXISTS IDX_NBCH24_LK_CAF_CUENTAS_01 ON ITF_LK_CAF_CUENTAS;
');

EXECUTE('
	CREATE NONCLUSTERED INDEX [IDX_NBCH24_REL_TJD_CTA_01] ON [dbo].[TJD_REL_TARJETA_CUENTA]
	(
	 [SALDO_JTS_OID] ASC,
	 [TZ_LOCK] ASC,
	 [ID_TARJETA] ASC,
...
EXECUTE('
	CREATE NONCLUSTERED INDEX [IDX_NBCH24_LK_CAF_CUENTAS_01] ON [dbo].[ITF_LK_CAF_CUENTAS]
	(
	 [ESTADO_CUENTA] ASC,
	 [SALDO_JTS_OID] ASC
	);
