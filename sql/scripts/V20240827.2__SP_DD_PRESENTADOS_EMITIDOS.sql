...
BEGIN
	...
	BEGIN
		...
		BEGIN 
			IF NOT EXISTS (SELECT 1 FROM snp_debitos WHERE ID_DEBITO=try_convert(NUMERIC(15,0),@t_id_archivo_reversado) AND TZ_LOCK=0) AND @t_trace2pre IS NULL AND @t_trace1pre IS NOT null
			BEGIN 
