Execute(' CREATE OR ALTER  PROCEDURE  SP_SIRCREB_PADRON_DEV
 @ARCHIVO VARCHAR(30) 
AS 
BEGIN 
...
FROM ITF_COMARB_DEVOLUCION (nolock) WHERE ID=@idCount ;
	...
	''V'', v.JTS_OID_SALDO, s.SUCURSAL, (CONVERT(NUMERIC(18,2),d.IMPORTE_TOTAL_CREDITO)*-1), d.TIPO_MONEDA, ''N'', d.ID, ''DEV_SIRCREB''
