EXECUTE('
DELETE CONCEPCONT WHERE C6500=801

INSERT INTO dbo.CONCEPCONT (TZ_LOCK, C6500, C6501, C6502, GRUPO_CONCEPTO, REFERENCIA)
VALUES (0, 801, ''Transit Sueldos Public'', 3117540008, ''0'', 0)
')

EXECUTE('
DELETE PLANCTAS WHERE C6326=3117540008
...
VALUES (0, ''Transitorio Sueldos Public'', 3117540008, ''N'', '' '', ''2'', ''C'', ''0'', ''  '', '' '', ''0'', ''  '', ''  '', ''  '', ''  '', ''  '', ''  '', '' '', '' '', 3117540008, ''N'', 0, 0, 0, 3117540008, 0, NULL, NULL, ''N'', ''N'', ''N'', '' '', 0, ''N'', ''N'', ''0'', 0, ''N'', ''N'', ''N'', ''N'', ''N'', ''311754'', ''N'')
')

EXECUTE('
UPDATE CONV_DOMINIOS SET CONC_CONT_TRANSITORIO = 801 WHERE ID_CONVENIO IN (SELECT ID_CONVPAGO FROM CONV_CONVENIOS_PAG WHERE Id_TpoConv IN (3,16))
')