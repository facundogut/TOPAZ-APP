	      ...
	      BEGIN
	      		INSERT INTO dbo.ITF_DD_PRESENT_RECIB_RECHAZOS (ID_TICKET,
													   ...
													   VALUES (@TICKET, @ContadorRegistros,
													   		   ...
													   		   @IdClientePegador,  
													   		   'I',  
													   		   (SELECT TOP 1 CODIGO_NACHA FROM SNP_MOTIVOS_RECHAZO WHERE FUNCIONALIDAD='DD'AND ID_MOTIVO=33),
													   		   @InfoAdicional,
	      ...
	      BEGIN
	     			      		INSERT INTO dbo.ITF_DD_PRESENT_RECIB_RECHAZOS (ID_TICKET, 
													   ...
													   VALUES (@TICKET, @ContadorRegistros,
													   		   ...
													   		   @IdClientePegador,  
													   		   'I',  
													   		   (SELECT TOP 1 CODIGO_NACHA FROM SNP_MOTIVOS_RECHAZO WHERE FUNCIONALIDAD='DD'AND ID_MOTIVO=45),
													   		   @InfoAdicional,
	      ...
	      BEGIN
	      			      		INSERT INTO dbo.ITF_DD_PRESENT_RECIB_RECHAZOS (ID_TICKET, TRACENUMBER,
													   ...
													   VALUES (@TICKET, @ContadorRegistros,
													   		   ...
													   		   @IdClientePegador,  
													   		   'I',  
													   		   (SELECT TOP 1 CODIGO_NACHA FROM SNP_MOTIVOS_RECHAZO WHERE FUNCIONALIDAD='DD'AND ID_MOTIVO=29),
													   		   @InfoAdicional,
	      ...
	      BEGIN
 	      			      		INSERT INTO dbo.ITF_DD_PRESENT_RECIB_RECHAZOS (ID_TICKET,  TRACENUMBER, 
													   ...
													   VALUES (@TICKET, @ContadorRegistros,
													   		   ...
													   		   @IdClientePegador,  
													   		   'I',  
													   		   (SELECT TOP 1 CODIGO_NACHA FROM SNP_MOTIVOS_RECHAZO WHERE FUNCIONALIDAD='DD'AND ID_MOTIVO=32),
													   		   @InfoAdicional,
	      ...
	      BEGIN
 	      			      		INSERT INTO dbo.ITF_DD_PRESENT_RECIB_RECHAZOS (ID_TICKET, TRACENUMBER, 
													   ...
													   VALUES (@TICKET, @ContadorRegistros,
													   		   ...
													   		   @IdClientePegador,  
													   		   'I',  
													   		   (SELECT TOP 1 CODIGO_NACHA FROM SNP_MOTIVOS_RECHAZO WHERE FUNCIONALIDAD='DD'AND ID_MOTIVO=34),
													   		   @InfoAdicional,
	      ...
	      BEGIN
	      			      		INSERT INTO dbo.ITF_DD_PRESENT_RECIB_RECHAZOS (ID_TICKET,  TRACENUMBER,
													   ...
													   VALUES (@TICKET, @ContadorRegistros,
													   		   ...
													   		   @IdClientePegador,  
													   		   'I',  
													   		   (SELECT TOP 1 CODIGO_NACHA FROM SNP_MOTIVOS_RECHAZO WHERE FUNCIONALIDAD='DD'AND ID_MOTIVO=36),
													   		   @InfoAdicional,
	      ...
	      BEGIN
	      			      		...
	      			      		INSERT INTO dbo.ITF_DD_PRESENT_RECIB_RECHAZOS (ID_TICKET,  TRACENUMBER,
													   ...
													   VALUES (@TICKET, @ContadorRegistros,
													   		   ...
													   		   @IdClientePegador,  
													   		   'I',  
													   		   (SELECT TOP 1 CODIGO_NACHA FROM SNP_MOTIVOS_RECHAZO WHERE FUNCIONALIDAD='DD'AND ID_MOTIVO=40),
													   		   @InfoAdicional,
	      ...
	      BEGIN
	      			      		INSERT INTO dbo.ITF_DD_PRESENT_RECIB_RECHAZOS (ID_TICKET,  TRACENUMBER,
													   ...
													   VALUES (@TICKET, @ContadorRegistros,
													   		   ...
													   		   @IdClientePegador,  
													   		   'I',  
													   		   (SELECT TOP 1 CODIGO_NACHA FROM SNP_MOTIVOS_RECHAZO WHERE FUNCIONALIDAD='DD'AND ID_MOTIVO=30),
													   		   @InfoAdicional,
	      ...
	      BEGIN
	      			      		INSERT INTO dbo.ITF_DD_PRESENT_RECIB_RECHAZOS (ID_TICKET,  TRACENUMBER,
													   ...
													   VALUES (@TICKET, @ContadorRegistros,
													   		   ...
													   		   @IdClientePegador,  
													   		   'I',  
													   		   (SELECT TOP 1 CODIGO_NACHA FROM SNP_MOTIVOS_RECHAZO WHERE FUNCIONALIDAD='DD'AND ID_MOTIVO=44),
													   		   @InfoAdicional,
