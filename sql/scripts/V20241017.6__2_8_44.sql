...
--------------------------------------------------------------------------------------------------------------
	...
	SELECT
	    ...
	    --8 Identificación del cliente beneficiario
		 ...
		 ,LEFT(UPPER((SELECT TOP 1 descripcion FROM SNP_MOTIVOS_RECHAZO WHERE id_motivo=TR.MOTIVO_RECHAZO AND FUNCIONALIDAD=''TR'' AND TZ_LOCK=0)) + REPLICATE('' '',44),44) AS RA_INFORMACION_ADICIONAL
