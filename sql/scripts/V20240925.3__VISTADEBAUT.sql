...
AS
SELECT ISNULL(b.CODIGO_COBRANZA,0) AS CODIGO,ISNULL(b.ORDEN,C.Prioridad) AS ORDEN,CD.CONVENIO,S.C1803 AS CLIENTE,DD.FECHA_NOVEDAD AS FECHA,0 AS TIPO,''C'' AS CLASIFICACION
