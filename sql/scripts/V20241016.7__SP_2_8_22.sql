Execute('
CREATE OR ALTER PROCEDURE [dbo].[SP_ITF_COELSA_CHE_PRESENTADOS_ENVIADOS]
@TICKET NUMERIC(16)
AS 
BEGIN
	SET NOCOUNT ON;
...
CREATE NONCLUSTERED INDEX [ix_itf_agip_padron_impuestos_aux_CUIT] ON [dbo].[ITF_AGIP_PADRON_IMPUESTOS_AUX] ([cuit])
')