...
SET @FECHA_PARAMETRO = CONVERT(DATETIME,''25/04/2025'',103);

DELETE FROM RRII_CHE_RECHAZADOS WHERE FECHA_REGISTRO_NOVEDAD<=@FECHA_PARAMETRO;
...
INSERT INTO RRII_CHE_RECHAZADOS (
    DEN_RECH,COD_ENTIDAD, NRO_SUCURSAL, CUENTA, NRO_CHEQUE, AVISO, COD_MOVIMIENTO, 
