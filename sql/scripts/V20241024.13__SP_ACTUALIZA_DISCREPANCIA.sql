...
BEGIN
	...
	BEGIN TRY
		...
		, c.CATEGORIAOBJETIVA, c.CATEGORIA_COMERCIAL, c.OBJETIVA_REFINANCIADO FROM CLI_CLIENTES c (nolock)
		INNER JOIN CRE_BCRA_CENDEU b WITH (nolock) ON c.CODIGOCLIENTE=b.CODIGOCLIENTE
		WHERE c.TZ_LOCK=0 AND b.TZ_LOCK=0  
		...
		WHERE c.TZ_LOCK = 0 AND c.CATEGORIA_COMERCIAL <> '' '' AND
