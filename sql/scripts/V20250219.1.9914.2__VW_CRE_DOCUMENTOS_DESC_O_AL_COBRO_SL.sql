EXECUTE('
IF OBJECT_ID (''dbo.VW_CRE_DOCUMENTOS_DESC_O_AL_COBRO_SL'') IS NOT NULL
	DROP VIEW dbo.VW_CRE_DOCUMENTOS_DESC_O_AL_COBRO_SL
')

EXECUTE('
CREATE VIEW  VW_CRE_DOCUMENTOS_DESC_O_AL_COBRO_SL AS
SELECT 
...
WHERE sal.ESTADO IN (1,2) AND sal.acreditado=0
