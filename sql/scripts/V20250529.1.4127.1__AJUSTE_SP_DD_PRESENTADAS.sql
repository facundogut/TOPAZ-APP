...
--s											, @RI_RESERVADO
   		...
   		INSERT INTO dbo.ITF_DD_PRESENTADOS_EMITIDOS_AUX (LINEA, CORRELATIVO,ID_ARCHIVO,NRO_ARCHIVO,PRESTACION,CLIENTE_ADHERIDO) VALUES (@RI_REGISTRO_INDIVIDUAL,@T_ID_DEBITO,@T_ID_ARCHIVO,@T_NRO_ARCHIVO,@T_PRESTACION,@T_CODIGO_CLIENTE);
		...
		BEGIN
			...
			IF @RI_INFO_ADICIONAL=''06''
	  		...
	  		INSERT INTO dbo.ITF_DD_PRESENTADOS_EMITIDOS_AUX (LINEA) VALUES (@RI_REGISTRO_INDIVIDUAL);
