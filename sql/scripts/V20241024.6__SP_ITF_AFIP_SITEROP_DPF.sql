...
BEGIN
    ...
    SELECT FORMAT((SELECT NUM1 FROM rri_parametros_inf WHERE CODIGO = 514
           ...
           FORMAT(CONVERT(NUMERIC,CONCAT(s.OPERACION,s.ORDINAL)),'0000000000000000000000') AS Numero_Operacion,
           FORMAT(s.SUCURSAL,'00000') as Codigo_Sucursal,
           CONVERT(VARCHAR(8),s.C1620,112)  as  Fecha_Constitucion,
           '2' AS Beneficiario_Exterior,
	...
	BEGIN      
        ...
        IF(@R04_MONTO_CONSTITUCION_PESOS_NUM >=@P_TOTAL_ACREDITACIONES)
         ...
         ,CANTIDAD_INTEGRATES 	,CODIGO_CAJA_VALORES_SA	,MONTO_CONSTITUCION_PESOS 	,MONTO_INTERES_PESOS 	,MONTO_CONST_MONEDA_OG 	,MONTO_INTERES_MONEDA_OG 	,TIPO_MONEDA     ,TIPO_MOVIMIENTO 	,FECHA_MOVIMIENTO ,FECHA_PROCESO )
