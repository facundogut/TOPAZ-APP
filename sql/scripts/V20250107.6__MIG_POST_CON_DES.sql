EXECUTE('
CREATE OR ALTER                                PROCEDURE [dbo].[MIG_POST_CON_DES]
...
SET @p_NomScr = ''POST_CON_DES''

-- Actualizo campo CANTIDADCUOTAS con valor C50094 --

UPDATE B 
SET B.CANTIDADCUOTAS = B.C50094
...
-- Actualizo campo C50094 con valor en 0 --
