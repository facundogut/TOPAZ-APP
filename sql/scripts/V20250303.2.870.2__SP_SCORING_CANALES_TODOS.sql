EXECUTE('
CREATE OR ALTER PROCEDURE dbo.SP_SCORING_CANALES_TODOS
         ...
         */
         ...
         DECLARE
             CUR_REGISTROS CURSOR LOCAL FOR 
               ...
               SELECT DISTINCT Producto, Convenio, JTS_OID, CantidadSueldo, Jurisdiccion, Canal, 
               TipoScoring, Afectacion, AfectacionCanal 
               FROM VW_PRODUCTOS_CONVENIOS_AH WHERE Cliente = @P_CLIENTE AND Situacion IN (''1'','' '')
