EXECUTE('
IF OBJECT_ID (''VW_NRO_CLIENTE_CREDEB'') IS NOT NULL
	DROP VIEW VW_NRO_CLIENTE_CREDEB
')
	
EXECUTE('CREATE VIEW [VW_NRO_CLIENTE_CREDEB] AS
SELECT DISTINCT
    CP.CODIGOCLIENTE AS NumeroCliente,
    PFPJ.TIPODOCUMENTO AS TipoDoc,
