EXECUTE('
IF OBJECT_ID (''dbo.ECOM_RECHAZO_NOV_ALTA'') IS NOT NULL
	DROP TABLE dbo.ECOM_RECHAZO_NOV_ALTA
')

EXECUTE('
CREATE TABLE dbo.ECOM_RECHAZO_NOV_ALTA
	(
...
EXECUTE('
IF OBJECT_ID (''dbo.ECOM_RECHAZO_NOV_COBRO'') IS NOT NULL
	DROP TABLE dbo.ECOM_RECHAZO_NOV_COBRO
')

EXECUTE('
CREATE TABLE dbo.ECOM_RECHAZO_NOV_COBRO
	(
	FechaRecepcion VARCHAR (8),
	FechaEnvio     VARCHAR (8),
	Asociacion     VARCHAR (3),
