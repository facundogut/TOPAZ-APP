...
VALUES
	...
	, 50
	, ''     DIA - Procesos de Cierre Integrada ''
	, ''VTA - Pago Intereses Vista Saldos Inmovilizados''
	, ''d''
	, 0
	, ''20990101''
	, 1
...
')
EXECUTE('
--''CRE - Revision tasas'' - CORRE MENSUAL
UPDATE dbo.PM_SCHEDULER
SET FECHAPROXEJECUCION = ''20990101''
WHERE ORDINAL = 80 AND NOMBREGRUPO = ''     DIA - Procesos de Cierre Integrada ''
')
EXECUTE('
...
UPDATE dbo.PM_SCHEDULER
SET FECHAPROXEJECUCION = ''20990101''
WHERE ORDINAL = 114 AND NOMBREGRUPO = ''     DIA - Procesos de Cierre Integrada ''
')
EXECUTE('
--''VTA - Cobro Intereses Deudores N Acuerdos'' - CORRE EL 5to DIA DEL MES
UPDATE dbo.PM_SCHEDULER
SET FECHAPROXEJECUCION = ''20241007''
