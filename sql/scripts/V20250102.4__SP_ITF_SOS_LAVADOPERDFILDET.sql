ALTER  PROCEDURE [dbo].[SP_ITF_SOS_LAVADOPERDFILDET]
AS
...
SELECT '0311' AS EMPRESA,
	...
	ISNULL((SELECT m.IngresoProyectado FROM ITF_MTO_X_MONOTRIBUTISTA m (NOLOCK) WHERE m.Categoria = pfj.MONOTRIBUTO
