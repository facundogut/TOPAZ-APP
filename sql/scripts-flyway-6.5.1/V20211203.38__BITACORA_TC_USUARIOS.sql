EXECUTE('
DROP TABLE IF EXISTS dbo.BITACORA_TJC_MAESTRO_USUARIO;
')
EXECUTE('
CREATE TABLE BITACORA_TJC_MAESTRO_USUARIO
	(
	...
	CONSTRAINT PK_BITACORA_TJC_MAESTRO_USUARIO_01 PRIMARY KEY (ADMINISTRADORA, USUARIO, FECHA_PROC, HORA_PROC)
	)
')
