EXECUTE('
IF OBJECT_ID (''dbo.PA_REC_VAL_DEBITOSAUTOMATICOS'') IS NOT NULL
	DROP PROCEDURE dbo.PA_REC_VAL_DEBITOSAUTOMATICOS')

EXECUTE('
CREATE PROCEDURE [dbo].[PA_REC_VAL_DEBITOSAUTOMATICOS]
