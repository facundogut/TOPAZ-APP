EXECUTE('
DROP PROCEDURE IF EXISTS SP_PA_REVISION_DE_TASAS_POST
')

EXECUTE('
CREATE PROCEDURE SP_PA_REVISION_DE_TASAS_POST
...
DECLARE @REVISION_TASAS_AUX TABLE (JTS_OID NUMERIC(10,0), TIPOTASAB VARCHAR(3),TNA_BASE_SALDO NUMERIC(11,7),
	...
	SELECT @P_DT_PROCESO=(SELECT FECHAPROCESO FROM PARAMETROS)
