...
WHEN ECE.NUMERODOCUMENTO IS NOT NULL THEN ''Cuit Librador''
...
LEFT JOIN VW_DEUDA_CLIENTES AD WITH(NOLOCK) ON A.JTS_OID=AD.JTS_OID
...
LEFT JOIN VW_CRE_DOCUMENTOS_DESC_O_AL_COBRO CD WITH(NOLOCK) ON CD.jts_oid = AD.JTS_OID
...
EXECUTE('
UPDATE dbo.AYUDAS
SET CAMPOS = ''565;760;617R;429;2616;2617;91R;804;35;427;376;127;2504R;665;''
	, CAMPOSVISTA = ''Producto;Nombre Producto;Cliente;Cuenta;Operacion;Desglose;Ex Graduación;Moneda;Saldo Deuda;Sucursal;Nombre Sucursal;Fecha Vencimiento;JTS OID;Familia;''
