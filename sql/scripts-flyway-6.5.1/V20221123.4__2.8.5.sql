...
SELECT ENTIDAD_DEBITAR, CODIGO_TRANSACCION, CUENTA_DEBITAR, IMPORTE, NRO_CHEQUE, CODIGO_POSTAL, INFO_ADICIONAL, PUNTO_INTERCAMBIO, TRACE_NUMBER
...
BEGIN
	...
	*/
	...
	SET @RI_REGISTRO_INDIVIDUAL = concat(@RI_ID_REG, @T_CODIGO_TRANSACCION, @RI_ENTIDAD_DEBITAR, @RI_RESERVADO, @RI_CUENTA_DEBITAR, @RI_IMPORTE, @RI_NUMERO_CHEQUE, @RI_CODIGO_POSTAL, @RI_PUNTO_INTERCAMBIO, @RI_INFO_ADICIONAL, @RI_REGISTRO_ADICIONAL, @RI_CONTADOR_REGISTRO);
 
    
    INSERT INTO dbo.ITF_ENVIO_DPF_PROPIOS_RECHAZADOS_AUX (LINEA) VALUES (replace(@RI_REGISTRO_INDIVIDUAL, ''.'', ''''));
	-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
')
EXECUTE('
CREATE TABLE dbo.ITF_ENVIO_DPF_PROPIOS_RECHAZADOS_AUX
	(
