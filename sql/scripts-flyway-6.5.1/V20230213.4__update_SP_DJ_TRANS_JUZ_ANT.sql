      ...
      BEGIN TRANSACTION	
       ...
       BEGIN TRY   
				...
				SET 
		  		...
		  		FROM 
		  				DJ_DEMANDADOS pd
		  		INNER JOIN @Tabla_DJ_DEMANDADOS AS dd ON pd.NRO_CAUSA=dd.NRO_CAUSA
				...
				SET 
		  		...
		  		INNER JOIN @Tabla_DJ_BENEFICIARIOS AS db ON pb.NRO_CAUSA=db.NRO_CAUSA AND pb.JTS_OID_CUENTA=db.JTS_OID_CUENTA
