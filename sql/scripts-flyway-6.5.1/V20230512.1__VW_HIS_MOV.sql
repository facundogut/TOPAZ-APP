EXECUTE('IF OBJECT_ID (''dbo.VW_HIS_MOV'') IS NOT NULL
...
SELECT hv.SUCURSAL,
	...
	CAST(CONCAT(VTA.NOMBRE_M, '' '', VTA.APELLIDO_M, '' - '', VTA.Tipo_Doc_M, '': '', VTA.Nro_Doc_M) AS CHAR(40)) AS IDENTIFICACION_DEPOSITANTE,
	...
	(CASE WHEN asiento.EXTORNO= 0 THEN ''NO EXTORNADO'' WHEN asiento.EXTORNO= 1 THEN ''EXTORNADO'' END) AS ASIENTO_EXTORNADO,
