Execute('ALTER TABLE TJD_TIPOS_NOVEDADES_LINK ALTER COLUMN ACCION VARCHAR(3);')

Execute('CREATE OR ALTER  PROCEDURE SP_ITF_LINK_TRX_REFRESH  @Error VARCHAR(200) OUTPUT
AS
BEGIN
    SET @Error = '' '';
...
Execute('
CREATE OR ALTER PROCEDURE SP_ITF_LINK_TRX_TARJETA_CUENTA  @Error VARCHAR(150)
...
WHERE NUMERODECAMPO = 34400 AND IDIOMA = ''E'' AND OPCIONINTERNA = ''BLQ''

DELETE FROM dbo.OPCIONES
WHERE NUMERODECAMPO = 34400 AND IDIOMA = ''E'' AND OPCIONINTERNA = ''D''

INSERT INTO dbo.OPCIONES (NUMERODECAMPO, IDIOMA, DESCRIPCION, OPCIONINTERNA, OPCIONDEPANTALLA)
VALUES (34400, ''E'', ''Bloqueo'', ''BLQ'', ''BLQ'')

INSERT INTO dbo.OPCIONES (NUMERODECAMPO, IDIOMA, DESCRIPCION, OPCIONINTERNA, OPCIONDEPANTALLA)
VALUES (34400, ''E'', ''Desbloqueo'', ''D'', ''D'')')