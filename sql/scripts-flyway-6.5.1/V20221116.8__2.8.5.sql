...
SELECT ENTIDAD_DEBITAR, CODIGO_TRANSACCION, CUENTA_DEBITAR, IMPORTE, NRO_CHEQUE, CODIGO_POSTAL, PUNTO_INTERCAMBIO, TRACE_NUMBER
...
OPEN CursorDPF
FETCH NEXT FROM CursorDPF INTO @T_ENTIDAD_DEBITAR, @T_CODIGO_TRANSACCION, @T_CUENTA_DEBITAR, @T_IMPORTE, @T_NRO_CHEQUE,@T_CODIGO_POSTAL,@T_PUNTO_INTERCAMBIO,@T_TRACE_NUMBER
