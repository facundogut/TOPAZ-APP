EXECUTE('
DELETE FROM OPERACIONES WHERE TITULO = 7901  AND IDENTIFICACION = 7933
...
VALUES (7901, 7933, ''ECOM-DJACUENTAS'', ''2.12.17 ECOM-DJACUENTAS'', ''7933'', ''N'', NULL, NULL, ''P'', 0, NULL, 0, ''S'', ''N'', ''N'', ''N'', ''N'', NULL, 0)
')