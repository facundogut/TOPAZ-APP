...
INNER JOIN ( 
	...
	WHERE ((PP.C2302<= (SELECT FECHAPROCESO FROM PARAMETROS WITH (NOLOCK))) 
	OR ((SELECT FECHAPROCESO FROM PARAMETROS WITH (NOLOCK)) BETWEEN PP.C2301 AND PP.C2302 AND PP.C2301 < 
