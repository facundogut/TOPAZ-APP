/****** Object:  StoredProcedure [dbo].[SP_AFIP_PUCA_IMP]    Script Date: 01/06/2021 13:08:57 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER   PROCEDURE [dbo].[SP_AFIP_PUCA_IMP] 
								@TICKET AS NUMERIC(16), 
								@iva VARCHAR(2) OUTPUT, 
								@iga VARCHAR(2) OUTPUT, 
								@mono VARCHAR(2) OUTPUT
...
BEGIN
	...
	SELECT I.IMPUESTO 
	FROM ITF_AFIP_IMP I with(nolock) 
