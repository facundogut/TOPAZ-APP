EXECUTE('DROP TABLE IF EXISTS dbo.ITF_COELSA_CHEQUES_TERCEROS;')
EXECUTE('
CREATE TABLE dbo.ITF_COELSA_CHEQUES_TERCEROS
	(
	...
	ESTADO             VARCHAR (1),
	TIPO               VARCHAR (1),
	CONSTRAINT PK__ITF_COELSA_CHEQUES_TERCEROS PRIMARY KEY (ID)
	);')
