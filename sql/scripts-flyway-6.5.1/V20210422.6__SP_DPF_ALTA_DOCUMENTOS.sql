/****** Object:  StoredProcedure [dbo].[SP_DPF_ALTA_DOCUMENTOS]    Script Date: 24/02/2021 9:24:55 ******/
DROP PROCEDURE [dbo].[SP_DPF_ALTA_DOCUMENTOS]
GO
...
CREATE PROCEDURE [dbo].[SP_DPF_ALTA_DOCUMENTOS]
