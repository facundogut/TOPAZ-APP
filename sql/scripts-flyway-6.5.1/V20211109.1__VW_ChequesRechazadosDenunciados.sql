EXECUTE('
IF OBJECT_ID (''VW_ChequesRechazadosDenunciados'') IS NOT NULL
	DROP VIEW VW_ChequesRechazadosDenunciados
')
EXECUTE('
create view VW_ChequesRechazadosDenunciados as
SELECT 
--1
