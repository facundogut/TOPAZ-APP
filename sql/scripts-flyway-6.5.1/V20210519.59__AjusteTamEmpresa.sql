EXECUTE('ALTER PROCEDURE OBTENER_TAMANO_EMPRESA
...
AS 
   ...
   --BEGIN
	...
	--	promedio personal ocupado
			...
			-- Antiguedad
			SELECT TOP 1 @NUMEROPERSONA = NUMEROPERSONA FROM CLI_ClientePersona WHERE TITULARIDAD = ''T'' AND TZ_LOCK = 0 AND CODIGOCLIENTE = @P_CODIGO_CLIENTE       
    ...
    BEGIN
     ...
     -- IF (@TIENE_BALANCE = 0) AND (@ANTIGUEDAD > 360)
      ...
      --  BEGIN 
       ...
       PRINT @TIENE_BALANCE 
       PRINT @ANTIGUEDAD 
       PRINT @INICIO_ACTIVIDAD_CONVERT 
