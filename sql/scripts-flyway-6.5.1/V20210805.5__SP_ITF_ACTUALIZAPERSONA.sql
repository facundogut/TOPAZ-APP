/****** Object:  StoredProcedure [dbo].[SP_ITF_ACTUALIZAPERSONA]    Script Date: 02/06/2021 10:18:10 ******/
SET ANSI_NULLS ON
GO
   ...
   BEGIN   	  
	  ...
	  WHILE @@FETCH_STATUS = 0
		BEGIN	 
			...
			SELECT @V_IVA = IVA, @V_IGA = IGA, @V_MONOTRIBUTO = MONOTRIBUTO 
		    ...
		    WHERE [CODIGOCLIENTE] = @cod_cli AND [CODIGOCLIENTE] IN 
        ...
        BEGIN      
		  ...
		  WHERE NUMEROPERSONAJURIDICA = @P_NUMPER;
      	  ...
      	  WHERE NUMEROPERSONAJURIDICA = @P_NUMPER 
				...
				AND (TZ_LOCK = 0 OR TZ_LOCK >= 200000000000000));
