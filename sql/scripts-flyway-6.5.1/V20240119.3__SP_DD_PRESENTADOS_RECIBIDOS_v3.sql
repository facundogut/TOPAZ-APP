execute('
DROP TABLE IF EXISTS dbo.ITF_DD_PRESENT_RECIB_RECHAZOS
...
CREATE TABLE dbo.ITF_DD_PRESENT_RECIB_RECHAZOS
	...
	SALDO_JTS_OID		NUMERIC(10,0),	--done
	MONEDA				NUMERIC(4,0),	--done
	fecha_vto			DATE,			--done
	fecha_comp			DATE,			--done
	cbu					VARCHAR(22),	--done
	referencia			VARCHAR(15),	--done
	codigo_cliente		NUMERIC(12,0),	--done
	cuit_eo				NUMERIC(11,0),	--done
	motivo_rechazo		VARCHAR(3),		--done
