execute('DROP TABLE IF exists dbo.ITF_DD_PRESENTADOS_EMITIDOS_AUX
...
CREATE TABLE dbo.ITF_DD_PRESENTADOS_EMITIDOS_AUX
	...
	, CORRELATIVO NUMERIC (12) NULL
	, ID_ARCHIVO  VARCHAR (30) NULL
	, NRO_ARCHIVO NUMERIC (15) NULL
	, PRESTACION  VARCHAR (10) NULL
	, CLIENTE_ADHERIDO NUMERIC(12) NULL
	)');
