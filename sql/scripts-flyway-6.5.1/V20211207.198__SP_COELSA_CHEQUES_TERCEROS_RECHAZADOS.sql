      	...
      	BEGIN
      		...
      		BEGIN
      			-- Insertamos en el historial
   				...
   				VALUES(@TICKET, @FECHA_ALTA, @BANCO_GIRADO, @SUCURSAL_BANCO, @NRO_CUENTA, @IMPORTE_TOTAL, @CODIGO_POSTAL, @NRO_DPF_CHEQUE, @PuntoIntercambio, @ContadorRegistros, ''A'', @MONEDA, @TIPO_DOCUMENTO, @CodRechazo);
   			END
      	END
