/****** Object:  StoredProcedure [dbo].[SP_INMOVILIZAR_SALDOS_DPF]    Script Date: 24/02/2021 9:35:48 ******/
DROP PROCEDURE [dbo].[SP_INMOVILIZAR_SALDOS_DPF]
GO
...
CREATE PROCEDURE [dbo].[SP_INMOVILIZAR_SALDOS_DPF]
			...
			SELECT 	S.CUENTA,
				...
				(SELECT E.EMAIL 
					FROM CLI_EMAILS E with (nolock), 
						CLI_CLIENTES CL with (nolock), 
						CLI_ClientePersona CP with (nolock), 
						PZO_SALDOS PS with (nolock)
