Execute('
CREATE OR ALTER   PROCEDURE [dbo].[SP_ITF_AGENCIEROS]
    @NRO_CUENTA NUMERIC(11, 0),
...
SET @ERRORFECHA = 0;
SET @ERRORS = '''';
SET @ESTADO = ''F''; --aca decia E
SET @DETALLE_ESTADO = ''Fallido'' --aca decia Error
BEGIN
    IF @CAJA_DEBITO = ''D''
    BEGIN
    ...
    BEGIN
        SET @ERRORS = ''0'';
        SET @ESTADO = ''H'';    ---aca decia v
        SET @DETALLE_ESTADO = ''Habilitado''  --aca decia Validado
    END
