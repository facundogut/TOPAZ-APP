EXECUTE('
CREATE PROCEDURE dbo.SP_TP_TLF_SUMMARY  
   /*
...
AS 
   ...
   DECLARE @RETORNO_CON_REGISTRO NUMERIC (12)
         ...
         INSERT dbo.TJD_TLF_SUMMARY(
            ...
            END
            AS TIPOMENSAJE, 
            (SELECT COD_MSJ_H2H FROM TLF_CODIGOS_OPERACIONES O WITH (NOLOCK) 
            ...
            INNER JOIN TLF_CODIGOS_OPERACIONES 
            ON COD_MSJ_TLF=LKTCDE+LKTFRO+LKTTO --JOIN CON  TABLA TLF_CODIGOS_OPERACIONES
            WHERE 
