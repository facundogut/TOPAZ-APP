EXECUTE('
DROP PROCEDURE IF EXISTS dbo.SP_CALCULA_GRADUACION
')

EXECUTE('
CREATE   PROCEDURE dbo.SP_CALCULA_GRADUACION
...
BEGIN
	...
	DECLARE @IMPORTE_A_EVALUAR NUMERIC (15,2);
 ...
 END
   ...
   IF(@ES_VINCULADO > 0 AND @EXCEDE_GRAD_VINC = ''S'')
   BEGIN
    SET @RESULTADO_GRADUACION = @RESULTADO_IND_VINC;
    SET @EXCEDE_GRADUACION_O = ''S'';
   END
 END
 ')