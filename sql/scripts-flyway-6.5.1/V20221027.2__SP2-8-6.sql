Execute('IF OBJECT_ID (''[dbo].[SP_ITF_COELSA_DPF_TERCEROS_PRESENTADOS_ENVIADOS]'') IS NOT NULL
	DROP PROCEDURE [dbo].[SP_ITF_COELSA_DPF_TERCEROS_PRESENTADOS_ENVIADOS]')
...
--agrego este insert para controlar campo a campo CABECERA DE LOTE Juan Pedrozo
--INSERT INTO ITF_AUX_COELSA_CABECERA_LOTE (ID_REG, CODIGO_CLASE_TRANSAC, RESERVADO, TIPO_REGISTRO, DESCRIP_TRANSAC , FECHA_PRESENTACION, FECHA_VENCIMIENTO , RESERVADO_CL,CODIGO_ORIGEN, ID_ENTIDAD_ORIGEN, NUMERO_LOTE) VALUES (@CL_ID_REG, @CL_CODIGO_CLASE_TRANSAC, @CL_RESERVADO, @CL_TIPO_REGISTRO, @CL_DESCRIP_TRANSAC, @CL_FECHA_PRESENTACION, @CL_FECHA_VENCIMIENTO, @CL_RESERVADO_CL, @CL_CODIGO_ORIGEN, @CL_ID_ENTIDAD_ORIGEN, @CL_NUMERO_LOTE);
...
IF(0<( --Grabo cabeceras solo si hay registros
...
DECLARE @RI_EXISTE VARCHAR(1) = ''0''; --PARA SABER CUANDO GRABAR PIES
...
----INSERT INTO ITF_AUX_COELSA_INDIVIDUAL (ID_REG, CODIGO_TRANSAC, ENTIDAD_DEBITAR, RESERVADO, CUENTA_DEBITAR, IMPORTE, NUMERO_CHEQUE, CODIGO_POSTAL, PUNTO_INTERCAMBIO,INFO_ADICIONAL, REGISTRO_ADICIONAL, CONTADOR_REGISTRO) VALUES (@RI_ID_REG, @RI_CODIGO_TRANSAC, @RI_ENTIDAD_DEBITAR, @RI_RESERVADO, @RI_CUENTA_DEBITAR, @RI_IMPORTE, @RI_NUMERO_CHEQUE, @RI_CODIGO_POSTAL, @RI_PUNTO_INTERCAMBIO, @RI_INFO_ADICIONAL, @RI_REGISTRO_ADICIONAL, @RI_CONTADOR_REGISTRO);
	...
	SET @RI_EXISTE = ''1''; --si existe, entonces grabo pies
...
IF(@RI_EXISTE = ''1'') --Grabo fin solo si hay registro
