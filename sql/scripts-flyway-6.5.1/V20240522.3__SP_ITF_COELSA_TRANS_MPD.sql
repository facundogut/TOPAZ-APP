...
-------------Grabamos el Fin de Archivo -------------------------------------------------------------------------------------------------------------------------------------
--SELECT ''FA FINAL'', @FA_SUMA_TOTAL_CREDITOS AS FA_SUMA_TOTAL_CREDITOS, @FA_TotalesCreditos AS FA_TotalesCreditos
...
--SET @FA_SUMA_TOTAL_CREDITOS = RIGHT(concat(replicate(''0'', 12), @FA_TotalesCreditos*100),12);
SET @FA_SUMA_TOTAL_CREDITOS = RIGHT(concat(replicate(''0'', 12), (replace(@TotalesCreditos, ''.'', ''''))),12);
--SELECT ''LOTES'', RIGHT(REPLICATE(''0'',7) + CAST(@CL_NUM_LOTE_CAB_NEW AS VARCHAR(7)),7) AS CL_NUM_LOTE_CAB_NEW;
