execute('
DROP TABLE IF exists dbo.ITF_IVARG17_PERCEPCION_ULT_PADRON_AUX
 ...
 --cargo tabla con nuevo padron
	...
	--doy de alta los registros que vienen en el nuevo padron
					...
					SELECT vw.ID_CARGO, 
					   		...
					   		vw.TASA,
					   		9999999999998
					FROM VW_CARGOS vw, ITF_IVARG17_PERCEPCION_ULT_PADRON_AUX a
					...
					SELECT vw.ID_impuesto, 
					   		...
					   		vw.TASA,
					   		9999999999998
					FROM VW_impuestOS vw, ITF_IVARG17_PERCEPCION_ULT_PADRON_AUX a	
