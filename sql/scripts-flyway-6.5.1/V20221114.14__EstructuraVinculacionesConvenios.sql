EXECUTE('
ALTER TABLE CRE_VINCULACIONES_CONVENIOS ADD CLAVE_ANSES VARCHAR(20)
')
...
left JOIN (
select ID_CONVENIO, ID_DOMINIO, MAX(DESCRIPCION) as DESCRIPCION ,  0 AS SUB_DOMINIO
from CONV_DOMINIOS WITH (NOLOCK)
GROUP BY ID_CONVENIO, ID_DOMINIO ) dom
...
EXECUTE('
ALTER TABLE CONV_DOMINIOS ALTER COLUMN DESC_SUB_DOMINIO VARCHAR (100)

ALTER TABLE CONV_DOMINIOS ALTER COLUMN DESCRIPCION VARCHAR (100)
')