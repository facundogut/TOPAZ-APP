...
BEGIN
  ...
  BEGIN TRY
      ...
      NOMBRE_TARJETA,SUCURSAL,ID_TARJETA_TITULAR,NRO_PERSONA,PERMISO,LIMITE_CREDITO,LIMITE_DEBITO,NUM_VERSION,DIGITO_VERIFICADOR)
      ...
      S.SUCURSAL,substring(Linea, 731, 19),DPFJ.NUMEROPERSONAFJ,''D'',substring(Linea,769,2) LimCre, substring(Linea,767,2) LimDeb,
      substring(Linea,763,1) Version,substring(Linea,764,1) Verificador
