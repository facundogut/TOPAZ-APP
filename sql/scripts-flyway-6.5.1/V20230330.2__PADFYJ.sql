...
AS 
   BEGIN
	...
	SELECT @V_FECHAPROCESO,@V_HORA, @P_USUARIO, ''BCRA'', ''CUIL'', b.CUIL, b.NOMBRE, ''DNI'', (SELECT SUBSTRING(CONVERT(VARCHAR(20),b.CUIL),3,8)), ''Alta'', ''La persona fue dada de alta como fallecida exitosamente.'',@P_TICKET 
