execute('
ALTER PROCEDURE PA_AGENCIEROS_ACTUALIZACION
...
AS 
   ...
   BEGIN
      ...
      INSERT INTO @RegistrosBancarizados
                 SELECT a.ID,am.ESTADO,am.ASIENTO_PROCESADO,am.FECHA_PROCESADO
      ...
      BEGIN
			...
			SET ESTADO = R.ESTADO, ASIENTO = R.ASIENTO_PROCESADO, FECHA_COBRO_PAGO = R.FECHA_PROCESADO, ESTADO_REND = ''P''
