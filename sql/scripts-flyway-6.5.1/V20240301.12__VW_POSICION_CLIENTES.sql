...
SELECT CLIENTE AS ''Cliente'', CLASIFICACION AS ''Clasificacion'',SUM (DEUDA_EXIGIBLE) AS ''Deuda Exigible'',SUM(DEUDA_NO_EXIGIBLE) AS ''Deuda no Exigible'',SUM(DEUDA_TOTAL) ''Deuda Total'',SUM(DEUDA_CONTINGENTE) ''Deuda Contingente'',
