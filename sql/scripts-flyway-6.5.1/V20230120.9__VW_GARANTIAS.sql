EXECUTE('
IF OBJECT_ID (''dbo.VW_GARANTIAS'') IS NOT NULL
...
AS 
	...
	INNER JOIN CRE_CLASGARANTIAS c ON g.TIPOGARANTIA = c.TIPOGARANTIA  AND c.SUBTIPOGTIA=g.SUBTIPOGARANTIA 
	AND c.COD_SUBCLA_GARANTIA=g.COD_SUBCLAGARANTIA AND c.PAIS_GARANTIA= g.PAIS_GARANTIA 
	AND c.TZ_LOCK = 0
