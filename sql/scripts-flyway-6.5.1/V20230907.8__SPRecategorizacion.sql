EXECUTE('
DROP PROCEDURE IF EXISTS dbo.SP_RECATEGORIZACION
')

EXECUTE('
CREATE PROCEDURE dbo.SP_RECATEGORIZACION
...
BEGIN
	...
	LEFT JOIN VTA_SOBREGIROS VS WITH(NOLOCK) ON VS.FECHA_ALTA = @f_proceso AND
	...
	SET @p_msg_proceso = ''El Proceso de recateorizacion ha finalizado correctamente. Registros procesados: ''+ CONVERT(VARCHAR(10), @contador)
	SET @p_ret_proceso = 1 		
