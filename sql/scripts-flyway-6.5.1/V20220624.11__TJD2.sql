...
EXECUTE('
UPDATE dbo.AYUDAS
SET CAMPOS = ''1360R;397;3843;1097;910;546;622;2487;''
	, CAMPOSVISTA = ''Id Solicitud;Tarjeta Base;Tarjeta Completa;Cuenta;Denominación Cuenta;Tipo Cuenta PBF;Número cuenta PBF;Estado;''
WHERE NUMERODEAYUDA = 34011

UPDATE dbo.DICCIONARIO
SET OPCIONES = 1
WHERE NUMERODECAMPO = 34873

INSERT INTO dbo.OPCIONES (NUMERODECAMPO, IDIOMA, DESCRIPCION, OPCIONINTERNA, OPCIONDEPANTALLA)
VALUES (34873, ''E'', ''Cuenta Corriente en Pesos'', ''1'', ''1'')

INSERT INTO dbo.OPCIONES (NUMERODECAMPO, IDIOMA, DESCRIPCION, OPCIONINTERNA, OPCIONDEPANTALLA)
VALUES (34873, ''E'', ''Caja de Ahorro en Pesos'', ''11'', ''11'')

INSERT INTO dbo.OPCIONES (NUMERODECAMPO, IDIOMA, DESCRIPCION, OPCIONINTERNA, OPCIONDEPANTALLA)
VALUES (34873, ''E'', ''Caja de Ahorro en Dólares'', ''15'', ''15'')
')