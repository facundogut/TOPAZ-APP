...
SELECT 
	...
	LEFT(concat((SELECT NUMERO_CUENTA_PBF FROM TJD_SOLICITUD_CUENTAS_LINK WHERE ID_SOLICITUD = ID_SOLICITUD AND NRO_CUENTA = NRO_CTA_PRIMARIA) , replicate('' '', 19)) , 19) AS nro_cuenta,	
