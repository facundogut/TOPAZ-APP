...
--cab	
	...
	INSERT INTO ITF_GIRELEC_AUX (ID_CABEZAL, CAMPO, TIPO) 		
		--SELECT CAB.ID AS idCabezal, Concat(''C'',dbo.NCADENAS(REL.SUCURSAL,4,''0'',''P''), oph
		SELECT CAB.ID AS idCabezal, Concat(''C'',dbo.NCADENAS(SUCFIC.SUCURSAL,4,''0'',''P''), 
		...
		--JOIN RelConvenioSucursalRendicion REL ON REL.TipoConvenio = CONV.Id_TpoConv AND REL.CANAL = CONV.Canal oph
		...
		--GROUP BY REL.SUCURSAL,CAB.FECHACARGA, CAB.ID, CAB.TOTALREGISTROS, CAB.TOTALIMPORTE --oph
