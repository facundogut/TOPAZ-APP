EXECUTE('
IF OBJECT_ID (''dbo.VW_CON_CERTIFICADOS_RETENCION'') IS NOT NULL
	DROP VIEW dbo.VW_CON_CERTIFICADOS_RETENCION
')
EXECUTE('
CREATE   VIEW VW_CON_CERTIFICADOS_RETENCION(
									NRO_CERTIFICADO,
									FECHA_RETENCION,
									CODIGO_CLIENTE,
									NOMBRECLIENTE,
...
INNER JOIN VW_CLI_DIRECCIONES CD ON
	...
	and cd.tipodireccion=(select top 1 tipodireccion from VW_CLI_DIRECCIONES where CODIGOCLIENTE = CCR.CODIGO_CLIENTE)
