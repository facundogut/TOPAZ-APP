...
EXECUTE ('
CREATE VIEW VW_VINCULADOS_GYF AS 
SELECT VG.ID AS ''Id'',
...
CASE WHEN VG.TIPO_VINCULACION=''P'' THEN VP.DESCRIPCION    
 ...
 VG.TOPE_FRACCIONAMIENTO_SING AS ''Tope Fraccionameinto Sin Garantía'',
 VG.TOPE_FRACCIONAMIENTO_CONG AS ''Tope Fraccionameinto Con Garantía''     
