--AJUSTE VW RRII_OPERACIONESPASIVAS
--NBCHSEG-5193
EXECUTE('
...
SELECT
	...
	CASE WHEN VCP.TIPOPERSONA = ''F'' THEN 
		''Persona Física''
	WHEN VCP.TIPOPERSONA = ''J'' THEN 
		''Persona Jurídica''
...
INNER JOIN VW_CLIENTES_PERSONAS VCP WITH (NOLOCK) on 
...
WHERE 
    ...
    PRD.C6255 != 0 AND
    DATEDIFF(DAY,S.C1621,S.C1627)>0
')
