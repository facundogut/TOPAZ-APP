...
CREATE TABLE dbo.ITF_AGIP_PADRON
	(
	Fecha_Vigencia_Desde VARCHAR (8),
	Fecha_Publicacion    VARCHAR (8),
	Fecha_Vigencia_Hasta VARCHAR (8),
	CUIT                 NUMERIC (11),
	Razon_Social         VARCHAR (60),
	Tipo_Contr_Insc      VARCHAR (1),
	Marca_alta_sujeto    VARCHAR (1),
	Alicuota_Percepcion  NUMERIC (6, 2),
	Alicuota_Retencion   NUMERIC (6, 2),
...
VALUES (0, 122, ''ITF AGIP - PADRON - 2.2.2'', ''ITF_AGIP_PADRON.kjb'', ''P'', ''S'', ''Nombre Archivo'', '' '', ''P'', ''S'', ''Periodo (AAAAMM) '', '' '', ''P'', ''S'', ''Reproceso'', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', '' '', ''J'', '' '', 0, ''M'')
')
