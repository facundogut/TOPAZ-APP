   ...
   DECLARE @RETORNO_CON_REGISTRO NUMERIC (12)
         ...
         INSERT dbo.TJD_TLF_SUMMARY(
            ...
            AS CODIGOPROCESAMIENTO, 
             ...
             substring(ITF_TLF_POS.LKPOST, 5, 2)+substring(ITF_TLF_POS.LKPOST, 3, 2) AS FECHATRANSACCION,  
             ...
             (SELECT H2H FROM dbo.COD_RETORNO_2H2_TLF O WITH (NOLOCK) 
              WHERE LKRES2=O.TLF)
               ...
               (CONVERT(varchar(12), ITF_TLF_POS.LKAMT1)) AS IMPORTE,  
            ...
            WHERE 
             ...
             ITF_TLF_POS.LKPOST=substring(REPLACE(CONVERT(VARCHAR,@P_FECHA,103),''/'',''''), 7 ,2)+substring(REPLACE(CONVERT(VARCHAR,@P_FECHA,103),''/'',''''), 3 ,2)+substring(REPLACE(CONVERT(VARCHAR,@P_FECHA,103),''/'',''''), 1 ,2)
