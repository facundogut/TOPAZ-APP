EXECUTE('
IF OBJECT_ID (''dbo.SP_DEBITOSAUTOMATICOS'') IS NOT NULL
	DROP PROCEDURE dbo.SP_DEBITOSAUTOMATICOS')
	
EXECUTE('	
CREATE  PROCEDURE SP_DEBITOSAUTOMATICOS @NRO_CUENTA NUMERIC(11,0),@TIPO_CUENTA NUMERIC(1,0),@JTS_OID NUMERIC(10,0) OUTPUT,@ERRORS VARCHAR(50) OUTPUT
AS
