...
SELECT 
	...
	ISNULL((SELECT SUM(SALDO_GASTO) FROM GASTOS_POR_CUOTA WITH (NOLOCK) WHERE SALDOS_JTS_OID=S.JTS_OID AND NUMERO_CUOTA=PP.NUMERO_CUOTA AND TZ_LOCK=0),0) AS GASTOS,	
