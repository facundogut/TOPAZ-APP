...
BEGIN
	...
	BEGIN
			...
			IF @t_trace1pre IS NOT NULL 
				SET @tracenumber_original=@t_trace1pre
			IF @t_trace2pre IS NOT NULL
				SET @tracenumber_original=@t_trace2pre
...
PRINT @tracenumber_original
PRINT @t_trace2pre
PRINT @t_trace1pre
PRINT @T_ID_ARCHIVO_REVERSADO
