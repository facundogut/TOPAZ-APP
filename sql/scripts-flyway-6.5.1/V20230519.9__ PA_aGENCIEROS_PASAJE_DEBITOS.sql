...
AS 
   ...
   BEGIN
      ...
      SELECT @IdConv_DB= NUMERICO FROM PARAMETROSGENERALES WHERE CODIGO = 300 AND TZ_LOCK = 0
	...
	INSERT INTO @RegistrosAgencieros 
      ...
      BEGIN
     			...
     			INSERT INTO GRL_ACREDITACIONES_MASIVAS (TIPO_CTA_DEB, CTA_DEB, SUC_DEB, ESTADO, FCHA_PROCESAR, TIPO_CTA_CRED, CTA_CRED, SUC_CRE, IMPORTE, MON_IMPORTE, APL_EVEN_CRE_DEB, TZ_LOCK, REFERENCIA_EXTERNA,TIPO_ACREDITACION
     			                                        ,EVENTO, EVEN_PAG_COB)--SE agrega NBCHSEG-4189 
				(SELECT
				''V'' AS TIPO_CTA_DEB, 
				@TRANS_DEBITO, 
				SUCURSAL, 
				...
				IMPORTE_LIQUIDO, 
				1 AS MON_IMPORTE, 
				''C'' AS APL_EVEN_CRE_DEB,--SE cambia a S NBCHSEG-4189  
				0 AS TZ_LOCK, 
