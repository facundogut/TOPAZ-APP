   ...
   DECLARE @flag INT;
      ...
      IF @P_TIPO_PERSONA = ''F''
      	BEGIN
      		...
      		IF @flag = 1
      			BEGIN
      				UPDATE CLI_PERSONASFISICAS SET SITUACION_JURIDICA = ''S'' WHERE ESTADO <> 1 AND NUMEROPERSONAFISICA = @P_NRO_PERSONA;
      ...
      ELSE
      	BEGIN
      		...
      		IF @flag = 1
      			BEGIN
      				UPDATE CLI_PERSONASJURIDICAS SET SITUACION_JURIDICA = ''S'' WHERE ESTADO <> 1 AND NUMEROPERSONAJURIDICA = @P_NRO_PERSONA;
