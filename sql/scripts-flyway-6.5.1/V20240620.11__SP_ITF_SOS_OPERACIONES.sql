...
FROM TJC_HISTORICO_PAGOS mov WITH (NOLOCK)
  ...
  INNER JOIN SOS_SUCURSALES suc WITH (NOLOCK) ON suc.Sucursal = B.SUC_CUENTA_COBRO
...
''0'' AS SUCURSALSISCEN,
--8
CONVERT(VARCHAR,B.CODSUCURSAL) AS SUCURSALINTERNA,
--9
...
--CLIENTE
null AS CUENTACLIENTE,
--SUCURSAL BCRA
null AS SUCURSALSISCENCTA,
--38
'''' AS REL_FON_TIT,
--39
''NO'' AS REL_PRO_TIT,
...
FROM ITF_I2000_MOVS_HIST mov WITH (NOLOCK)
  ...
  INNER JOIN SOS_SUCURSALES suc WITH (NOLOCK) ON suc.Sucursal = B.CODSUCURSAL
