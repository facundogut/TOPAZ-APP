...
BEGIN
	...
	@f_proceso
	FROM @TBL_AUX T
	INNER JOIN VTA_SOBREGIROS VS WITH(NOLOCK) ON VS.NRO_AUTORIZACION=T.NRO_AUTORIZACION
	...
	SET @p_msg_proceso = ''El Proceso de recateorización ha finalizado correctamente. Registros procesados: ''+ CONVERT(VARCHAR(10), @contador)
	SET @p_ret_proceso = 1 		
