/****** Object:  StoredProcedure [dbo].[SP_LINK_TRK]    Script Date: 01/06/2021 12:46:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[SP_LINK_TRK]
...
BEGIN
    ...
    BEGIN
		SET @flag = (SELECT COUNT(*) 
					FROM TJD_LINK_MAESTRO_CUENTA WITH (NOLOCK) 
