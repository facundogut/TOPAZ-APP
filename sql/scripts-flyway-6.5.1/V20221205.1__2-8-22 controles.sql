EXECUTE('
CREATE OR ALTER PROC [dbo].[SP_ITF_COELSA_CHE_PRESENTADOS_ENVIADOS]
@TICKET NUMERIC(16)
AS 
BEGIN
	SET NOCOUNT ON;
...
EXECUTE('
DELETE dbo.ITF_MASTER_PARAMETROS WHERE CODIGO = 139
')
...
VALUES (139, 11, ''Control fecha 2.8.22'', '' '', '' '', '' '', 0, 0, NULL, 0, 0, 0)
')
