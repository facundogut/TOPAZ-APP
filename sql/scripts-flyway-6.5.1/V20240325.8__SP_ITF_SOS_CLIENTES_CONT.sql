...
BEGIN
  ...
  SET @PERIODO = SUBSTRING(CONVERT(VARCHAR, @FechaIni, 112),1,6);
	...
	FROM CLI_CLIENTES cli (NOLOCK)
	  ...
	  INNER JOIN CLI_DIRECCIONES dir (NOLOCK) ON dir.ID = nat.NUMEROPERSONAFISICA 
	  											AND dir.FORMATO = ''PF'' 
	  											AND dir.TIPODIRECCION = ''F''
	...
	''N'' AS MARCASUELDO,
	--48
	CANTIDAD_EMPLEADOS AS TAMANIOEMPRESA,
	--49
	jur.MONOTRIBUTO,
	--
	cli.CODIGOCLIENTE
	...
	FROM CLI_CLIENTES cli (NOLOCK)
	  ...
	  INNER JOIN CLI_DIRECCIONES dir (NOLOCK) ON dir.ID = jur.NUMEROPERSONAJURIDICA 
	  											AND dir.FORMATO = ''PJ'' 
