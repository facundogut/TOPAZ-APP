...
EXECUTE('
IF OBJECT_ID (''VW_ULTIMOS_10_MOVS_2'') IS NOT NULL
	DROP VIEW VW_ULTIMOS_10_MOVS_2
	')
	
	EXECUTE('


CREATE VIEW [VW_ULTIMOS_10_MOVS_2] (FECHAPROCESO, HORASISTEMA, CLIENTE, SUCURSAL_CUENTA, CUENTA, MONEDA, PRODUCTO, SUCURSAL, FECHAVALOR, ASIENTO, COD_TRANSACCION, DESC_TRANSACCION, CONCEPTO, CAPITALREALIZADO, DEBITOCREDITO, NUMERO_CHEQUE, OPERACION_CUENTA, ORDINAL_CUENTA, INIUSR, OPERACION_TOPAZ,NROCAJA, SALDO_JTS_OID)
AS 
