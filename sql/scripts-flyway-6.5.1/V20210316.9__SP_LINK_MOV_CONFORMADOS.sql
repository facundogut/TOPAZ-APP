EXECUTE('DROP PROCEDURE IF EXISTS dbo.SP_LINK_MOV_CONFORMADOS;')
EXECUTE('CREATE  PROCEDURE SP_LINK_MOV_CONFORMADOS 
...
BEGIN
	...
	SELECT
		...
		RIGHT(REPLICATE(''0'', 23)+ CAST(vt.CTA_CBU AS VARCHAR(23)), 23) AS ''cbu'',	 
