EXECUTE('
CREATE OR ALTER   PROCEDURE SP_ITF_LINK_TRX_TARJETA_CUENTA  
...
BEGIN
	BEGIN TRY
      ...
      SET @Error = '' '';
            ...
            SELECT 0, NroTarjeta,S.JTS_OID,Tipo_Cuenta, (CASE WHEN TJD_CTA.CUENTA = 1 THEN 1 ELSE 0 END),S.PRODUCTO,S.CUENTA,S.MONEDA,
            S.SUCURSAL,0,Estado_Cuenta, 
            (SELECT substring(Linea, 185, 19) FROM ITF_LINK_TRK where substring(Linea,731,19) = TJD_CTA.NroTarjeta)
            FROM TJD_ITF_TARJETAS_CUENTAS TJD_CTA
