...
BEGIN
	...
	DECLARE @IdEntidadOrigen VARCHAR(8);
	...
	--sera el acumulador de importes, para luego comparar con el fin de archivo
      ...
      BEGIN
			...
			BEGIN
				...
				BEGIN
					...
					INSERT INTO ITF_COELSA_SESION_RECHAZADOS
						(ID_TICKET, FECHA_ALTA, BANCO, SUCURSAL, CUENTA, IMPORTE, CODIGO_POSTAL, NRO_CHEQUE, PUNTO_INTERCAMBIO, TRACK_NUMBER, TIPO, MONEDA, TIPO_DOCUMENTO)
					VALUES(@TICKET, @FechaPresentacion, @Entidad_RI, @Sucursal_RI, @NumeroCuenta_RI, @Importe, @CodigoPostal_RI, @NumeroCheque_RI, @PuntoIntercambio, @ContadorRegistros, ''D'', 2, @TIPO_DOCUMENTO);
				END
