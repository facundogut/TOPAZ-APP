execute('
	...
	DROP TABLE if exists dbo.SNP_MSG_ORDENES
...
CREATE TABLE dbo.SNP_MSG_ORDENES
	...
	ID_ARCHIVO_REVERSADO     VARCHAR (30),
...
BEGIN
	...
	IF (@T_PRES_1ER_VTO =(SELECT FECHAPROCESO FROM PARAMETROS))
	BEGIN
	...
	BEGIN
		...
		SET @RI_REGISTRO_INDIVIDUAL = concat(''705'',
										 ...
										 RIGHT(concat(replicate(''0'', 7),(SELECT NUMERICO_1 FROM ITF_MASTER_PARAMETROS WHERE CODIGO = 148)), 7)
										 );
