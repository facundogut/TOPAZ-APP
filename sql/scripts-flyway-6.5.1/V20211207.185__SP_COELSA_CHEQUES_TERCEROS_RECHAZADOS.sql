...
BEGIN  
      ...
      BEGIN
      	...
      	BEGIN
      		...
      		UPDATE dbo.CLE_CHEQUES_AJUSTE SET ESTADO_AJUSTE = ''R'' WHERE ESTADO_AJUSTE IS NULL AND TRACKNUMBER = @ContadorRegistros;
...
UPDATE dbo.CLE_CHEQUES_AJUSTE SET ESTADO_AJUSTE = ''A'' WHERE (ESTADO_AJUSTE IS NULL AND ESTADO_AJUSTE <> ''R'') AND ESTADO = ''P''; 
------------------------------------------------------------------------------------------------------------------------------
