...
--								, t.letra_alicuota 
	...
	--- ACTUALIZO PADRON-----
	DELETE FROM ITF_AGIP_PADRON WHERE Fecha_VIGENCIA_DESDE=(SELECT TOP 1 CONVERT(DATE, SUBSTRING(fecha_vig_desde,5,4)+'-' +SUBSTRING(fecha_vig_desde,3,2)+'-'+SUBSTRING(fecha_vig_desde,1,2))FROM ITF_AGIP_PADRON_IMPUESTOS_AUX WHERE msj_error='' OR msj_error IS NULL)
