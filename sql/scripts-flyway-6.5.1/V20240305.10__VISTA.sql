...
SELECT v.ID_VINCULO, ISNULL(CDV.CODIGOCLIENTE, 0) AS CLIENTE_VINCULADO, ISNULL(CDV.NOMBRECLIENTE, PFJ.NOMBRE) AS NOMBRE_VINCULADO,
...
LEFT JOIN CLI_CLIENTES CLI WITH(NOLOCK) ON CDV.CODIGOCLIENTE = CLI.CODIGOCLIENTE
