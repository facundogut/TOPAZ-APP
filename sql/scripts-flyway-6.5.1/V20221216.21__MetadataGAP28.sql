EXECUTE('
IF OBJECT_ID (''dbo.VW_RRII_ANEXO_12_RENGLON18'') IS NOT NULL
	DROP VIEW dbo.VW_RRII_ANEXO_12_RENGLON18
')
EXECUTE('
CREATE   VIEW [dbo].[VW_RRII_ANEXO_12_RENGLON18] 
AS
--18)
SELECT
    18 AS NRO_CAMPO,
