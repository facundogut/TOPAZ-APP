/****** Object:  StoredProcedure [dbo].[SP_DJ_VALIDO_BAJA_PODER]    Script Date: 02/06/2021 17:44:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[SP_DJ_VALIDO_BAJA_PODER]
...
BEGIN
	...
	BEGIN
		...
		WHERE A.ID_ENTIDAD = @pJtsOidCta AND
		A.TIPO_PODER = @pTipoPoder AND
		A.TIPO_ENTIDAD = 2 AND
		A.ID_PERSONA = @pNroPersona AND
		A.FECHA_INI_SUSPENSION IS NULL AND
		A.TZ_LOCK = 0
