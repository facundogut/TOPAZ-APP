execute('CREATE OR ALTER FUNCTION dbo.CredComp(
    @periodo VARCHAR(1),
    @jts NUMERIC(10,0),
    @fechaDesde DATE,
    @fechaHasta DATE 
...
WITH COBROS_CREDEB AS (
    SELECT
        ...
        CASE
            WHEN C6403 = ''I'' THEN (FL.MONTO_FACTURABLE * HTC.TIPO_CAMBIO_VENTA)
            WHEN C6403 = ''N'' THEN FL.MONTO_FACTURABLE
            ELSE (FL.MONTO_FACTURABLE * COT.TC_VENTA)
    ...
    LEFT JOIN CI_IMPUESTOS_TARIFAS AS CI WITH (nolock) ON
        ...
        AND CI.RANGO_HASTA = (
            ...
            WHERE ID_IMPUESTO = CI.ID_IMPUESTO
                ...
                AND ((TZ_LOCK < 100000000000000 OR CI.TZ_LOCK >= 200000000000000)
