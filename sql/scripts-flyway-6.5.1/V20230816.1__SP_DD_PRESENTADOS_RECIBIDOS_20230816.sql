...
BEGIN 
	...
	BEGIN
      ...
      BEGIN
			...
			BEGIN
				SET @MSJ =  ''Tama񯠲egistro debe ser 094'';
				RETURN
			END
      ...
      BEGIN
			...
			BEGIN
				SET @MSJ =  ''Fecha Presentaci󮠥s obligatorio'';
				RETURN;
			END
	...
	BEGIN TRY
		...
		VALUES(@NroArchivo, ''C'', @CUIT_EO , @PRESTACION, @FechaVencimiento, @NIdClientePegador --@Cod_Cliente
