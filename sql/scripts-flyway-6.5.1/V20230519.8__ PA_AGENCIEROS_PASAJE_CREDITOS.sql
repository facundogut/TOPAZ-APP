...
execute('
ALTER PROCEDURE PA_AGENCIEROS_PASAJE_CREDITOS
...
AS 
   ...
   BEGIN
      ...
      SELECT @IdConv_CR= NUMERICO FROM PARAMETROSGENERALES WHERE CODIGO = 301 AND TZ_LOCK = 0;
	...
	INSERT INTO @RegistrosAgencieros 
      ...
      BEGIN
     			...
     			INSERT INTO GRL_ACREDITACIONES_MASIVAS (TIPO_CTA_DEB, CTA_DEB, SUC_DEB, ESTADO, FCHA_PROCESAR, TIPO_CTA_CRED, CTA_CRED, SUC_CRE, IMPORTE, MON_IMPORTE, APL_EVEN_CRE_DEB, 
     			                                        ...
     			                                        EVENTO, EVEN_PAG_COB)--SE agrega a S NBCHSEG-4189 
				(SELECT
				''V'' AS TIPO_CTA_DEB, 
				JTS_OID, 
				SUCURSAL, 
				...
				@FECHA, 
				''V'' AS TIPO_CTA_CRED, 
				@TRANS_CREDITO AS CTA_CRED,
				SUCURSAL AS SUC_CRE, 
				IMPORTE_LIQUIDO, 
				1 AS MON_IMPORTE, 
				''D'' AS APL_EVEN_CRE_DEB,--SE cambia NBCHSEG-4189 
				0 AS TZ_LOCK, 
