	...
	BEGIN
		...
		BEGIN		
			...
			BEGIN
				...
				VALUES (@ID_CABEZAL, @ID_LINEA, @NRO_06, @NRO_02, @CADENA_12, @CADENA_12, ''I'', ''Ingresado'', @CargoEspec, @TZ_LOCK,@FECHA_01);
	...
	BEGIN
		...
		WHILE @@fetch_status = 0 
			BEGIN
				...
				VALUES (@ID_CABEZAL, @ID_LINEA, CAST(@CADENA_07 AS NUMERIC(4,0)), @NRO_07, @CADENA_12, @CADENA_12, ''I'', ''Ingresado'', 0, @TZ_LOCK);
