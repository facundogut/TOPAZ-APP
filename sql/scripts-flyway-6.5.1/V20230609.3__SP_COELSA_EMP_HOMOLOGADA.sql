...
BEGIN
	...
	BEGIN
		...
		(@IdEmpresa,@NombreEmpresa ,@DescTransaccion ,@EntidadOrigen ,'''' ,@LongClaveCliente ,@SegundoVencimiento ,@PeriocidadPago ,@ComisionUsoCuenta, (SELECT FECHAPROCESO FROM PARAMETROS WITH(NOLOCK)), (SELECT MAX(X.Id_ConvRec) 
