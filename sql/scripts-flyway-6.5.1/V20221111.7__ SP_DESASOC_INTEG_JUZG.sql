EXECUTE('
CREATE PROCEDURE SP_DESASOCI_INTE_JUZG
   @P_NUM_JUZG  float(12),
...
AS 
   ...
   BEGIN
	  ...
	  WHERE s.NRO_JUZGADO = @P_NUM_JUZG
		...
		AND tt.TIPO_ENTIDAD = 2 AND tt.ID_ENTIDAD = cc.JTS_OID_CUENTA AND tt.ID_PERSONA = @P_NUM_PER
      ...
      BEGIN TRANSACTION	
       ...
       BEGIN TRY
				...
				SET 
					...
					P.FECHA_INI_SUSPENSION = @FECHA_ANTERIOR
				...
				INNER JOIN @Tabla_ASOCI_INTE_JUZG AS T ON
					...
					AND P.ID_ENTIDAD  = T.JTS_OID_CUENTA
