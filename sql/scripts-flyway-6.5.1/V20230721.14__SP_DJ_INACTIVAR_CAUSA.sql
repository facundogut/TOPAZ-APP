   ...
   BEGIN
      ...
      BEGIN TRANSACTION	
       ...
       BEGIN TRY
				...
				UPDATE P
				SET 
					P.FECHA_INI_SUSPENSION = T.FECHA_VENCIMIENTO, --@P_FECHA_VENCIMIENTO,
				...
				INNER JOIN @Tabla_INACTIVAR_CAUSA AS T ON
					...
					AND P.ID_ENTIDAD = TRY_CAST(T.JTS_OID_CUENTA AS VARCHAR(50))
					AND P.TIPO_PODER = T.TIPO_PODER
					AND P.FECHA_INI_SUSPENSION IS NULL 
					--AND P.ID_CLIENTE_SALDO = NULL
