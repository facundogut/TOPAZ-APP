EXECUTE('
/****** Object:  StoredProcedure [dbo].[SP_MAILS_CARGOS_PENDIENTES]    Script Date: 01/06/2021 15:22:58 ******/
SET ANSI_NULLS ON
...
BEGIN
	...
	(	SELECT E.EMAIL 
		...
		INNER JOIN CLI_EMAILS AS E with (nolock) ON  E.ID = T.NUMEROPERSONA
													AND T.TZ_LOCK = 0 
													AND E.TZ_LOCK = 0
													AND T.TITULARIDAD = ''T''
