...
AS
SELECT b.CODIGO_COBRANZA AS CODIGO,b.ORDEN,DD.JTS_DEBITO,S.C1803 AS CLIENTE,DD.FECHA_COBRANZA AS FECHA,0 AS TIPO,''C'' AS CLASIFICACION
...
CREATE VIEW dbo.VW_CRE_ORDEN_COBRANZA_SUELDOS
AS
SELECT DA.CODIGO,
DA.ORDEN,
DA.JTS_DEBITO,
