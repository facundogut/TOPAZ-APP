...
WHERE CUIT IN (SELECT cuit FROM ITF_COMARB_PADRON_IMPUESTOS_AUX)
AND PERIODO_APLICACION= @perParam

DELETE FROM ITF_LOG_PADRON_IMPUESTOS
WHERE COD_CLIENTE IN (SELECT cp.CODIGOCLIENTE 
